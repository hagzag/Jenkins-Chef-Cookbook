...
# Completely optional. Comment out if undesirable.
...
# Using remote_file seemed to cause issues.
...
## An example plugin install. Comment out or change if necessary.
# Installs the github plugin.
jenkins "github" do
...
# Installs the github authorization plugin.
